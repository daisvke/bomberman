...
<img src="/screenshots/img/item-bomb.png"/>Bomb = allows the player to set an additional bomb on the field<br />
<img src="/screenshots/img/item-fire.png" />Fire = increases the power of the bombs set by the player
