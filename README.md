...
<img src="/img/item-speed.png" /> Speed = allows the player to move faster<br />
<img src="/img/item-bomb.png"/>Bomb = allows the player to set an additional bomb on the field<br />
<img src="/img/item-fire.png" />Fire = increases the power of the bombs set by the player
