...
/*   Updated: 2021/10/05 21:10:51 by dtanigaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sl_load_all_textures(t_env *env)
{
	...
	sl_load_texture(env, &env->icons.p1, "./img/display-white-icon.xpm");
	sl_load_texture(env, &env->icons.bomb, "./img/display-bomb.xpm");
